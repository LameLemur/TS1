...
public class EShopController {
    ...
    public static void purchaseShoppingCart(ShoppingCart cart, String customerName, String customerAddress) throws NoItemInStorage, EmptyShoppingCart {
    ...
    public static void main(String[] args) throws NoItemInStorage, EmptyShoppingCart {
